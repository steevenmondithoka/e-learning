...
const AddCourse = () => {
  ...
  return (
    <div className='h-screen overflow-x-auto flex flex-col items-start justify-between md:p-8 md:p-4 pt-8 pb-0 ml-2'>

      <form action="" onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-full text-gray-500'>
        ...
        <div className='flex items-center justify-between flex-wrap'>
          ...
          <div className='flex md:flex-row flex-col items-center gap-3'>
            ...
            <label htmlFor="thumbnailImage" className='flex items-center gap-3'>
              <img src={assets.file_upload_icon} alt="" className='p-3 bg-blue-500 rounded hover:cursor-pointer' />
              <input type="file" name="" id="thumbnailImage" onChange={e => setImage(e.target.files[0])}
                accept='image/*' hidden />
            ...
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
              <div className='flex justify-between items-center p-4 border-b'>
                <div className='flex items-center'>
                  ...
                  src={assets.dropdown_icon} width={14} alt="" className={`mr-2 cursor-pointer transition-all 
                ...
                <span className='text-gray-600'>{chapter.chapterContent.length} Lectures</span>
              ...
              {!chapter.collapsed && (
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                      <span>{lectureIndex + 1}{lecture.lectureTitle}-{lecture.lectureDuration} mins
                        - <a href={lecture.lectureUrl} target='blank' className='text-blue-500'>Link</a> - {
                  ...
                  <div className='inline-flex bg-gray-100 p-2 rounded
                       cursor-pointer mt-2 text-gray-700' onClick={()=>handleLecture('add',chapter.chapterId)}>Add Lectures</div>
                </div>
              )}
            </div>
          ))}
          <div className='flex justify-center items-center bg-blue-300 p-2 hover:bg-blue-500 hover:text-white
             rounded-lg cursor-pointer text-black' onClick={() => handleChapter('add')}>Add Chapter</div>
          {showPopup && (
              ...
              <div className='bg-white text-gray-700 p-4 rounded relative w-full
                ...
                <div className='mb-2'>
                  ...
                  <input type="checkbox"
                    ...
                    onChange={(e) => setLectureDetails({
                      ...lectureDetails, isPreviewFree: e.target.value
                    })} />

                </div>

                <button type='button' className='w-full
                          bg-blue-400 text-white px-4 py-2 rounded' onClick={addLecture}>Add</button>
        ...
        <button type='submit' className=' bg-gray-700 hover:bg-black text-white w-max py-2.5 px-8 rounded my-4'>
          Add
