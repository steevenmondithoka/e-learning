    ...
    px-8 md:pt-30 pt-20 text-left'>
         ...
         <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                     ...
                     <p className='text-blue-600'>({courseData.courseRatings.length} 
                      ...
                      <p>{courseData.enrolledStudents.length}
                         {courseData.enrolledStudents.length>1 ? 'Studnents' : 'Student'}</p>
                   </div>

                 
                  <p className='text-sm'>Course By <span className='text-blue-600 
                  underline'>E-Learning</span></p>
      ...
      md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
              ...
              <div className='flex gap-3 items-center pt-2'>
                ...
                <p className='md:text-lg text-grey-500 line-through'>{currency} {courseData.coursePrice}</p>
